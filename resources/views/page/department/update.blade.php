<!-- Modal toggle -->
<button
  data-modal-target="{{$department->id}}-crud-modal"
  data-modal-toggle="{{$department->id}}-crud-modal"
  class=""
  type="button">
...
<div
  ...
  <div class="relative p-4 w-full max-w-md max-h-full">
    ...
    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
      ...
      <!-- Modal body -->
      <form class="p-4 md:p-5" method="post" action="{{route('department.update', $department)}}">
        @csrf
        @method('put')
