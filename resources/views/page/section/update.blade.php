<!-- Modal toggle -->
<button
  data-modal-target="{{$section->id}}-crud-modal"
  data-modal-toggle="{{$section->id}}-crud-modal"
  class=""
  type="button">
...
<div
  ...
  <div class="relative p-4 w-full max-w-md max-h-full">
    ...
    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
      ...
      <!-- Modal body -->
      <form class="p-4 md:p-5" method="post" action="{{route('section.update', $section)}}">
        @csrf
        @method('put')
