   ...
   <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
    <caption class="py-2 px-3  bg-white  dark:bg-gray-800">
     <div class="flex justify-between items-center">
      <span class="font-semibold  text-lg text-left rtl:text-right text-gray-900 dark:text-white">{{$section->section_name}}</span>
      <span class="text-sm dark:text-white text-gray-900">Total students: {{$section->users->count()}}</span>
     </div>
    </caption>
    ...
    <tbody>
     ...
     <tr class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-600">
      ...
      <td scope="row" class="px-6 py-4">
       <a href="{{route('block.view.student',[ $section, $user])}}">
